...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'host' => env('LARAVEL_ODOO_API_HOST','https://demo5.odoo.com'),
    ...
    |--------------------------------------------------------------------------
    */
    'db' => env('LARAVEL_ODOO_API_DB_NAME','demo5'),
    ...
    |--------------------------------------------------------------------------
    */
    'user' => env('LARAVEL_ODOO_API_USER_NAME', 'admin'),
    ...
    |--------------------------------------------------------------------------
    */
    'password' => env('LARAVEL_ODOO_API_USER_PASSWORD', 'admin'),
